...
export const Footer=()=>{
    return (
        ...
        <h3 className="font-bold text-2xl ml-8 sm:ml-20 mt-4"><img src="https://storage.googleapis.com/pr-newsroom-wp/1/2018/11/Spotify_Logo_RGB_White.png" className="w-32" alt="splogo"/></h3>
